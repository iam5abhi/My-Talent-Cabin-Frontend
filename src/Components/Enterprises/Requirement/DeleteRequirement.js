...
export default function DeleteRequirement({setOpen,open,id,GetNoticeData}) {
  ...
  const DeleteQuesSubmit = async ()=>{ 
    try {
      const resp = await authFetch.delete(`/api/enterpricess/notice-board/${id}`)
                    ...
                    <div className="  bg-white border col-span-2">
                      <div className=" border-b border-gray-200 rounded p-7">
                        <div className="text-center">
                          <h3 className='text-2xl font-medium mb-2'>Delete Requirement</h3>
                          <p className=" text-base font-medium mb-6">
                            If u delete the Requirement you can't recover it
                          </p>
                        </div>
                        <div className="">
