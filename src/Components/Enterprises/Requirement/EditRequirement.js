...
export default function AddRequirement({ setOpen, open, GetNoticeData, id }) {
  const cancelButtonRef = useRef(null)
  const [message, setMessage] = useState({ message: '', type: '' })
  const [notice, setNotice] = useState({ title: '', description:'' ,minexp:'', maxexp:'', 
  ...
  const SubmitQuesHandler = async (event) => {
    ...
    try {
      const resp = await authFetch.patch(`/api/enterpricess/notice-board/${id}`, { title:notice.title,
      description:notice.description,tags:subCategoryData});
  ...
  const GetRequirementData = async () => {
    try {
      const resp = await authFetch(`/api/enterpricess/notice-board/${id}`);
      setNotice({ title: resp.data.data.title, description: resp.data.data.description, title: resp.data.data.title,
      description:resp.data.data.description ,minexp:resp.data.data.minexp, maxexp:resp.data.data.maxexp, minsalary:resp.data.data.minsalary,
      maxSalary:resp.data.data.maxSalary,vancancy:resp.data.data.vancancy, location:resp.data.data.location})
      setSubCategoryData(resp.data.data.tags)
    } catch (error) {
      console.log(error)
    }
  }
                                ...
                                <li className="w-full rounded-t-lg mb-2">
                                  <div className="items-center px-3">
                                    <label htmlFor="first_name" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Title <span class="text-red-600">*</span></label>
                                      <input type="text" id="default-input" name='title' value={notice.title} onChange={NoticeHandler} placeholder="Enter Title" className="bg-gray-50 border border-gray-300 text-gray-900 text-lg font-normal rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-1.5" required />
                                  </div>
                                </li>
                                <li className="w-full rounded-t-lg mb-2">
                                  <div className="items-center px-3">
                                    <label htmlFor="first_name" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Minimum Exprience <span class="text-red-600">*</span></label>
                                      <input type="Number" id="default-input" name='minexp' value={notice.minexp} onChange={NoticeHandler} placeholder="Enter Minimum Exprience" className="bg-gray-50 border border-gray-300 text-gray-900 text-lg font-normal rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-1.5" required />
                                  </div>
                                </li>
                                <li className="w-full rounded-t-lg mb-2">
                                  <div className="items-center px-3">
                                    <label htmlFor="first_name" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Maximum Exprience <span class="text-red-600">*</span></label>
                                      <input type="Number" id="default-input" name='maxexp' value={notice.maxexp} onChange={NoticeHandler} placeholder="Enter Maximum Exprience" className="bg-gray-50 border border-gray-300 text-gray-900 text-lg font-normal rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-1.5" required />
                                  </div>
                                </li>
                                <li className="w-full rounded-t-lg mb-2">
                                  <div className="items-center px-3">
                                    <label htmlFor="first_name" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Minimum Salary <span class="text-red-600">*</span></label>
                                      <input type="text" id="default-input" name='minsalary' value={notice.minsalary} onChange={NoticeHandler} placeholder="Enter Minimum Salary" className="bg-gray-50 border border-gray-300 text-gray-900 text-lg font-normal rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-1.5" required />
                                  </div>
                                </li>
                                <li className="w-full rounded-t-lg mb-2">
                                  <div className="items-center px-3">
                                    <label htmlFor="first_name" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Maximum Salary <span class="text-red-600">*</span></label>
                                      <input type="text" id="default-input" name='maxSalary' value={notice.maxSalary} onChange={NoticeHandler} placeholder="Enter Maximum Salary" className="bg-gray-50 border border-gray-300 text-gray-900 text-lg font-normal rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-1.5" required />
                                  </div>
                                </li>
                                <li className="w-full rounded-t-lg mb-2">
                                  <div className="items-center px-3">
                                    <label htmlFor="first_name" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Number Of Vancancy <span class="text-red-600">*</span></label>
                                      <input type="Number" id="default-input" name='vancancy' value={notice.vancancy} onChange={NoticeHandler} placeholder="Enter Number Of Vancancy" className="bg-gray-50 border border-gray-300 text-gray-900 text-lg font-normal rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-1.5" required />
                                  </div>
                                </li>
                                <li className="w-full rounded-t-lg mb-2">
                                  <div className="items-center px-3">
                                    <label htmlFor="first_name" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Location <span class="text-red-600">*</span></label>
                                      <input type="text" id="default-input" name='location' value={notice.location} onChange={NoticeHandler} placeholder="Enter Location" className="bg-gray-50 border border-gray-300 text-gray-900 text-lg font-normal rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-1.5" required />
                                  </div>
                                </li>
                                <li className="w-full rounded-t-lg mb-2">
                                  <div className="items-center px-3">
                                    <label htmlFor="first_name" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Description <span class="text-red-600">*</span></label>
                                      <textarea type="text" id="default-input" name='description' value={notice.description} onChange={NoticeHandler} placeholder="Enter Description" className="bg-gray-50 border border-gray-300 text-gray-900 text-lg font-normal rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-1.5" required />
                                    </div>
                                </li>
                                <li className="w-full rounded-t-lg mb-2">
                                  <div className="items-center px-3 ">
