...
export default function DeleteNotice({setOpen,open,id,GetNoticeData}) {
  ...
  const DeleteQuesSubmit = async ()=>{ 
    try {
      const resp = await authFetch.delete(`/api/campus/delete-notice/${id}`)
                    ...
                    <div className="  bg-white border col-span-2">
                      <div className=" border-b border-gray-200 rounded p-7">
                        <div className="text-center">
                          <h3 className='text-2xl font-medium mb-2'>Delete Notice</h3>
                          <p className=" text-base font-medium mb-6">
                            If u delete the Notice you can't recover it
                          </p>
                        </div>
                        <div className="">
