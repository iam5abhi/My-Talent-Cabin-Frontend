...
export default function EducationAdd({setOpen,open,GetProfileData}) {
    ...
    const SubmitProfileData =async()=>{
        try {
          const resp = await authFetch.post(`/api/student/education`,{data:FormData});
          setMessage({message:"Add Sucessfully",type:true})
          setTimeout(() => {
            setOpen(false)
            GetProfileData()
            ...
            >
                ...
                <div className="container mx-auto">
                    ...
                    <span className="flex justify-end -mt-1 -mr-1 text-xl">
                        ...
                        <br />
                    <div>  
                      <select id="Status" onChange={ProfileHandler} defaultValue={"status"} name='academicname' className="mb-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" >
                                  <option value='status' >Choose a Education</option>
                                  <option value="12th">12th</option>
                                  <option value="Graduation">Graduation</option>
                                  <option value="Post Graduation">Post Graduation</option>
                                  <option value="PHD">PHD</option>
                      </select>
                      <input type="text" id="default-input" name='institution' onChange={ProfileHandler} placeholder="Enter Institution" className="mb-3 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" />
                      <input type="text" id="default-input" name='percentage' onChange={ProfileHandler} placeholder="Enter Percentage" className="mb-3 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" />
                      <input type="month" id="default-input" name='passingYear' onChange={ProfileHandler} placeholder="Enter Passing Year" className="mb-3 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" />
                    </div>
