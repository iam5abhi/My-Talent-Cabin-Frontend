...
//         <Text style={styles.content}>
//           <span style="font-bold">{internName}</span>
//         </Text>
...
//         <Text style={styles.internshipDuration}>
    ...
    <Page orientation="landscape" size="A4" style={style.certificate_container} >
        <View style={style.certificate}>
            ...
            <View style={style.certificate_header}>
                <Image src="https://rnmastersreview.com/img/logo.png" style="logo" alt />
            </View>
            <View style={style.certificate_body}>
                ...
                <Text style={style.student_name}>Matthew Taylor</Text>
                ...
                <Text style={style.certificate_footer }>
                    <View style={style.row}>
                        <Text className="col-md-6">
                            <Text>Principal: ______________________</Text>
                        </Text>
