...
import PersonalInformation from "../../Components/Enterprises/Profile/PersonalInformation"; 
import Specialization from "../../Components/Enterprises/Profile/Specialization"; 
import Copyright from "../../Components/Enterprises/Profile/Copyright"
import Sidebar from "../../Components/Enterprises/Profile/Sidebar"
import ProfilePicture from '../../Components/Enterprises/Profile/ProfilePicture';
...
const Profile = () => {
    ...
    useEffect(() => {
       if(loction.pathname=="/auth/enterpricess/profile"){
  ...
  return (
        ...
        <div className="lg:flex gap-x-4 w-[90%] mx-auto">
            ...
            <Route path='personal-information' element={<React.Suspense fallback={<><Breathing width={1200} height={1000} /></>}>
                  ...
                  <Route path='business-information' element={<React.Suspense fallback={<><Breathing width={1200} height={1000} /></>}>
                        <PrivateRoute>
                          <Specialization />
                        </PrivateRoute>
                  </React.Suspense>}/>
