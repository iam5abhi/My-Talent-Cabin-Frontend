...
export default function UploadAssignmentModal({setOpen,open,SubmitAssginment}) {
                  ...
                  <div className="  bg-white border col-span-2">
                    <div className=" border-b border-gray-200 rounded">
                      ...
                      <p className="  text-lg  font-semibold text-gray-600">
                         Are u sure submit this assignment?
                        </p>
                        <p className=" text-base  text-gray-400">
                        If u submit this assignment you can't change it
                        </p>
                      </div>                   
