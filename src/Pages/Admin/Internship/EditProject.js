          ...
          <section className="border border-gray-200 rounded-lg px-4 py-10">
            <div className="grid grid-cols-2 gap-20  ">
              <div className="mb-6">
                ...
                <input type="text" id="large-input" name='title' value={formData.title} onChange={FormOnChangeHandler} className="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-orange-500 focus:border-orange-500 " />
              </div>
              <div className="text-end">
                <button type="button" onClick={FormSubmitHandler} className="text-white text-end bg-orange-600 hover:bg-orange-400 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Edit Project</button>
              </div>
            </div>
            <br />
            <div className="grid gap-6 md:grid-cols-1 pt-2">
              <div className="col-span-1">
                ...
                <input id="default-radio-1" type="radio" onChange={FormOnChangeHandler} checked={formData.weeks=='Winter'} name="weeks" value='Winter' className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 " />
                <label htmlFor="bordered-checkbox-1" className="w-full py-4 ml-2 text-base font-medium text-gray-900">Winter</label> &nbsp;
                <input id="default-radio-1" type="radio" onChange={FormOnChangeHandler} checked={formData.weeks=='Summer'} name="weeks" value='Summer' className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 " />
            ...
            <div className="grid gap-6 md:grid-cols-1 pt-2">
              <div className="col-span-1">
                ...
                <input id="default-radio-1" type="radio" onChange={FormOnChangeHandler} name="intershipType" checked={formData.intershipType=='paid'} value='paid' className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 " />
                <label htmlFor="bordered-checkbox-1" className="w-full py-4 ml-2 text-base font-medium text-gray-900">Paid</label> &nbsp;
                <input id="default-radio-1" type="radio" onChange={FormOnChangeHandler} name="intershipType" checked={formData.intershipType=='unpaid'} value='unpaid' className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 " />
            ...
            {formData.intershipType == "paid" ? <>
              <div >
                ...
                <input type="text" id="small-input" name='price' onChange={FormOnChangeHandler} value={formData.price} placeholder='Enter Price' className="block w-full ml-2 p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-orange-500 focus:border-orange-500 " />
              </div>
              <br />
            </>
              : null}
